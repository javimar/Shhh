...
import eu.javimar.shhh.sync.BackgroundTasks;
import eu.javimar.shhh.sync.RegisteringIntentService;
...
public final class NotificationUtils
{
    ...
    public static void notify_geofences_loaded(Context context)
    {
        NotificationCompat.Builder builder = new NotificationCompat.Builder(context, GEO_CHANNEL_ID)
                ...
                .addAction(ignoreLoadingWarningsAction(context))
    ...
    private static Action ignoreLoadingWarningsAction(Context context)
    {
        Intent dismissIntent = new Intent(context, RegisteringIntentService.class);
        dismissIntent.setAction(BackgroundTasks.ACTION_DISMISS_NOTIFICATION_GEO_REGISTRATION);
        PendingIntent dismissPendingIntent = PendingIntent.getService(
                context,
                ACTION_DISMISS_NOTIFICATION_GEO_REGISTERING_PENDING_INTENT_ID,
                dismissIntent,
    ...
    /**
     * HELPER LOGIC RELATED TO ALL NOTIFICATIONS
     */
